...
namespace HolidayWeb.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(SignInManager<HolidayUser> signInManager, UserManager<HolidayUser> userManager, IDepartment departmentRepository, IRuntime _Runtime)
        {
        ...
        public async Task<IActionResult> Login(LoginViewModel loginViewModel)
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded)
                {
                    _runtime.currentUserId = user.Id;
