#pragma checksum "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b483c722d20694a2dda555bc900d3a6117301505"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b483c722d20694a2dda555bc900d3a6117301505", @"/Views/Home/Scheduler.cshtml")]
...
#line 19 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
               Write(!(SignInManager.IsSignedIn(User) && User.IsInRole("ADMIN")));
...
#line 119 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
           Write(Html.Raw(Newtonsoft.Json.JsonConvert.SerializeObject(userManager.Users)));

#line default
#line hidden
            EndContext();
            BeginContext(3192, 11579, true);
            WriteLiteral(@";
            ...
            ,
            {
                ...
                editorOptions: {
                    ...
                    onValueChanged: function (args) {
                        ...
                        var startE");
            WriteLiteral(@"ditor = form.getEditor(""startDate"");
...
//            form.getEditor(""userEditor"").option(""value"", ViewBag.currentUser.Id);
        ...
        //showToast2(""zzzzzzzzz");
            WriteLiteral(@"zzzzzzzzzzz "" + test2);
    }
...
#line 391 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
             Write(Url.Action("Post", "Home"));

#line default
#line hidden
            EndContext();
            BeginContext(14798, 681, true);
            WriteLiteral(@""",
