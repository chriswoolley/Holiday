#pragma checksum "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "117ede7e39e33b51908bb6226b340db440c1ab21"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"117ede7e39e33b51908bb6226b340db440c1ab21", @"/Views/Home/Scheduler.cshtml")]
...
//    var test1 = $runtime.currentUserId;
    ...
    function appointmentForm_created(data) {
        ...
        if (HolidayAppointment.AppointmentId == undefined) {
            Sele");
            WriteLiteral(@"ctUserId = currentUserId;
            SelectTypeId = 0;
            ...
            if (adminSignedIn == true) {
                ...
                DisplayReadOnly = true;
            ");
            WriteLiteral(@"    NewAppointmentOrAdminReadState = false;
                option = option + 32;
            }
        }
...
//        showToast2(""ReadOnlyStatus:"" + ReadOnlyStatus);
        ...
        form.option(
            ...
            ""items"", [
                {
                    ...
                    editorOptions: {
                        dataSource: Users,
                     ");
            WriteLiteral(@"   displayExpr: ""UserName"",
                        valueExpr: ""Id"",
                        value: SelectUserId,
            ...
            ,
            {
                ...
                editorType: ""dxSelectBox"",
                editorOptions: {
                    dataSource: [{ ""ID"": 0, ""periodName"": ""Morning"" }, { ""ID"": 1, ""periodN");
            WriteLiteral(@"ame"": ""Afternoon"" }],
                    valueExpr: ""ID"",
  ...
  ");
            WriteLiteral(@"                      form.getEditor(""startDateEditor"").option(""value"", testDate);
            ...
            ,
            {
                ...
                ,
                {
                    ...
                    editorOptions: {
                        dataSource: [{ ""ID"": 0, ""periodName"": ""Morning"" }, { ""ID"": 1, ""periodNam");
            WriteLiteral(@"e"": ""Afternoon"" }],
                        valueExpr: ""ID"",
                        displayExpr: ""periodName"",
                        readOnly: NewAppointmentOrAdminReadState,
                     ...
                     ");
            WriteLiteral(@"       var testDate = data.appointmentData.endDate;
...
//            AppointmentId: e.appointmentData.AppointmentId,
            ...
            RecurrenceRule: e.appointmentData.Recurrence");
            WriteLiteral(@"Rule,
