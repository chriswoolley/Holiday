#pragma checksum "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b28f2b124dcd0fdbc1ff7bf017c35ddf5ffc1dc5"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b28f2b124dcd0fdbc1ff7bf017c35ddf5ffc1dc5", @"/Views/Home/Scheduler.cshtml")]
...
#line hidden
        ...
        if (HolidayAppointment.AppointmentId == undefined) {
            ...
            option = option + 8;
            if (a");
            WriteLiteral(@"dminSignedIn == ""True"") {
                DisplayReadOnly = false;
                NewAppointmentOrAdminReadState = false;
                option = option + 16;
            }
...
//            AppointmentId: e.appointmentData.AppointmentId,
            ...
            Description: e.appoi");
            WriteLiteral(@"ntmentData.Description,
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(14671, 26, false);
#line 379 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
             Write(Url.Action("Post", "Home"));

#line default
#line hidden
            EndContext();
            BeginContext(14697, 1463, true);
            WriteLiteral(@""",
...
//            AppointmentId: e.appointmentData.AppointmentId,
            ...
            RecurrenceRule: e.appointmentData.RecurrenceRule,
            DepartmentID: e.appointmentData.DepartmentID,
            StatusKey: e.appointmentData.Statu");
            WriteLiteral(@"sKey,
            UserID: e.appointmentData.UserID,
            HolidaysTaken: e.appointmentData.HolidaysTaken,
            Duration: e.appointmentData.Duration,
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(16161, 25, false);
#line 419 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
             Write(Url.Action("Put", "Home"));

#line default
#line hidden
            EndContext();
            BeginContext(16186, 680, true);
            WriteLiteral(@""",
            contentType: ""application/json"",
            dataType: ""json"",
            data:  JSON.stringify(data),
