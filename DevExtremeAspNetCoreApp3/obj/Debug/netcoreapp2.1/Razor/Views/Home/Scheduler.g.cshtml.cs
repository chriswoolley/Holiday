#pragma checksum "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6339060c2d55643fd26e65a9431d391ef25b894b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6339060c2d55643fd26e65a9431d391ef25b894b", @"/Views/Home/Scheduler.cshtml")]
...
#line hidden
            ...
            WriteLiteral("\';\r\n");
            EndContext();
            BeginContext(564, 111, true);
            WriteLiteral("</script>\r\n\r\n<div class=\"row\">\r\n\r\n    <h2></h2>\r\n\r\n    <br />\r\n    <br />\r\n    <br />\r\n    <br />\r\n\r\n\r\n\r\n\r\n    ");
            EndContext();
            BeginContext(677, 3698, false);
#line 34 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
...
#line 112 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
         Write(currentID);
...
#line 113 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
...
#line hidden
            EndContext();
            BeginContext(4607, 21, true);
            WriteLiteral(";\r\n\r\n    var Users = ");
            EndContext();
            BeginContext(4629, 72, false);
#line 120 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
           Write(Html.Raw(Newtonsoft.Json.JsonConvert.SerializeObject(userManager.Users)));

#line default
#line hidden
            EndContext();
            BeginContext(4701, 894, true);
            WriteLiteral(@";
...
#line hidden
            EndContext();
            BeginContext(5628, 33, true);
            WriteLiteral("\';\r\n        var adminSignedIn = \'");
            EndContext();
            BeginContext(5663, 56, false);
#line 152 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
                         Write(SignInManager.IsSignedIn(User) && User.IsInRole("Admin"));

#line default
#line hidden
            EndContext();
            BeginContext(5720, 8911, true);
            WriteLiteral(@"';
           ...
           ");
            ...
            WriteLiteral(@"aField: ""EndPeriod"",
                    ...
                    editorOptions: {
                        ...
                        onValueChanged: function (args) {
                            ...
                            var day = startDate.getDate();
                            if (args.value === 0) {
                                data.appointmentData.endDate = new Date(year, mo");
            WriteLiteral(@"nth, day, 13, 0, 0, 0);
            ...
            ,
            {
                ...
                editorOptions: {
                    ...
                    value: SelectTypeId,
               ");
            WriteLiteral(@"     readOnly: DisplayReadOnly
                }
                }
...
//            AppointmentId: e.appointmentData.AppointmentId,
         ...
         ");
            WriteLiteral(@"   Description: e.appointmentData.Description,
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(14632, 26, false);
#line 371 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
             Write(Url.Action("Post", "Home"));

#line default
#line hidden
            EndContext();
            BeginContext(14658, 1312, true);
            WriteLiteral(@""",
...
//                alert('done');
    ...
    function EditedData(e) {
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(15971, 25, false);
#line 407 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
             Write(Url.Action("Put", "Home"));

#line default
#line hidden
            EndContext();
            BeginContext(15996, 646, true);
            WriteLiteral(@""",
            contentType: ""application/json"",
            dataType: ""json"",
            data:  JSON.stringify(data),
