#pragma checksum "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0ff7d74ef1bd83518fdfa4c59147a58973f3d68f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0ff7d74ef1bd83518fdfa4c59147a58973f3d68f", @"/Views/Home/Scheduler.cshtml")]
...
#line hidden
        ...
        showToast2(""SelectUserId:"" + SelectUserId + "" SelectTypeId:"" + SelectTypeId +  "" option:"" + option + "" currentUserId:"" + currentUserId + "" isSignedIn:"" + isSignedIn + "" adminSignedIn:"" + adminSignedIn + "" DisplayReadOnly:"" + DisplayReadOnly + "" NewAppointmentOrAdminReadState:"" + NewAppointmentO");
            WriteLiteral(@"rAdminReadState);
            ...
            ,
            {
                ...
                editorOptions: {
                    ...
                    onValueChanged: function (args) {
                        ...
                        if (args.value === 0) {
                            data.appointmentDat");
            WriteLiteral(@"a.startDate = new Date(year, month, day, 9, 0, 0, 0);
                ...
                ,
                {
                    ...
                    editorOptions: {
                        ...
                        onValueChanged: function (args) {
                            ...
                            if (args.value === 0) {
           ");
            WriteLiteral(@"                     data.appointmentData.endDate = new Date(year, month, day, 13, 0, 0, 0);
