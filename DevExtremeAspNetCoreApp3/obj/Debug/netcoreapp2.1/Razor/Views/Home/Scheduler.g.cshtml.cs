#pragma checksum "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b21c21f9c67dc29536491082045a42ed100bed70"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b21c21f9c67dc29536491082045a42ed100bed70", @"/Views/Home/Scheduler.cshtml")]
...
#line hidden
        ...
        if (HolidayAppointment.AppointmentId == undefined) {
            ...
            if (adminSignedIn == ""True"") {
                ...
                DisplayReadOnly = true; //((SelectUserId = currentUserId) && (SelectTypeId = 0));
        ...
        showToast2(""SelectUserId:"" + SelectUserId + "" SelectTypeId:"" + SelectTypeId +  "" option:"" + option + "" currentUserId:"" + currentUserId + "" isSignedIn:"" + isSignedIn + "" adminSignedIn:"" + adminSignedIn + "" Display");
            WriteLiteral(@"ReadOnly:"" + DisplayReadOnly + "" NewAppointmentOrAdminReadState:"" + NewAppointmentOrAdminReadState);
   ...
   ");
            ...
            ,
            {
                ...
                editorOptions: {
                    ...
                    readOnly: NewAppointmentOrAdminReadState,
                    o");
            WriteLiteral(@"nValueChanged: function (args) {
                    }
                }
            }
                ,
            ...
            ,
            {
                ...
                editorType: ""dxSelectBox"",
                editorOptions: {
                    dataSource: [{ ""ID"": 0, ""Status"": ""Requested"" }, { ""ID"": 1, ""Status"": ""Granted"" }, { ""ID"": 2, ""Status"": ""Denied"" }, { ""ID"": 3, ""Status"": ""D");
            WriteLiteral(@"elayed"" }],
                    valueExpr: ""ID"",
                    displayExpr: ""Status"",
                    value: SelectTypeId,
    ...
    function InsertData(e) {
        ...
        var data = { // to be replaced with form va");
            WriteLiteral(@"lues
//            AppointmentId: e.appointmentData.AppointmentId,
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(14803, 26, false);
#line 369 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
             Write(Url.Action("Post", "Home"));

#line default
#line hidden
            EndContext();
            BeginContext(14829, 1312, true);
            WriteLiteral(@""",
...
//                alert('done');
    ...
    function EditedData(e) {
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(16142, 25, false);
#line 405 "C:\HolidayManager\DevExtremeAspNetCoreApp3\Views\Home\Scheduler.cshtml"
             Write(Url.Action("Put", "Home"));

#line default
#line hidden
            EndContext();
            BeginContext(16167, 646, true);
            WriteLiteral(@""",
            contentType: ""application/json"",
            dataType: ""json"",
            data:  JSON.stringify(data),
