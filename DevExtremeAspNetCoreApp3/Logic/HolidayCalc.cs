...
namespace HolidayWeb.Core
{
    ...
    public class HolidayCalc : IHolidayCalc
    {
        ...
        public void HolidayRemaining(IEnumerable<HolidayUser> users, DateTime whichYear)
        {
            ...
            {
                test.HolidaysAssigned = _holidayEntitlement.GetUserHolidayEntitlement(test.Id, whichYear.Year);
                test.HolidaysRemaining = test.HolidaysAssigned - HolidaysBookthisYear(test.Id, whichYear.Year);
            }
        }
    }
}